...
abstract public class GeometricObject
{
	...
	{
		String str;
		str = boundaryColor.getRed() + " " + boundaryColor.getGreen() + " " + boundaryColor.getBlue() + " "
				+ boundaryColor.getAlpha() + " " + interiorColor.getRed() + " " + interiorColor.getGreen() + " "
				+ interiorColor.getBlue() + " " + interiorColor.getAlpha();
